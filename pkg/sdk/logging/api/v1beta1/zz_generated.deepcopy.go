...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FluentdSpecRef) DeepCopyInto(out *FluentdSpecRef) {
	*out = *in
	in.FluentdSpec.DeepCopyInto(&out.FluentdSpec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FluentdSpecRef.
func (in *FluentdSpecRef) DeepCopy() *FluentdSpecRef {
	if in == nil {
		return nil
	}
	out := new(FluentdSpecRef)
	in.DeepCopyInto(out)
	return out
}
